<template>
  <div>
    <div>
      <!-- <a href="http://localhost:8080/#/secondInfo?id=1">aa</a> -->
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="title" label="房屋简介" width="350" />
...
export default {
  ...
  methods: {
    ...
    handleClick(row, index) {
      ...
      // let id = row.id
      // let str="http://localhost:8080/#/secondInfo?id="+id
      // alert(str)
      // window.location.href="http://localhost:8080/#/secondInfo?id=1"
      // window.open("http://192.168.1.5:8080/#/secondInfo?id=1","_blank");
